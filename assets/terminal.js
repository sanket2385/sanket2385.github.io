(function (global, undefined) {
	...
	var Terminal = Terminal || function(containerID, options) {
		...
		_terminal.insertAdjacentHTML('beforeEnd', [
			...
			'<tr><td nowrap><div class="prompt">' + options.prompt + options.separator + '</div></td><td width="100%"><input class="cmdline" autofocus autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" /></td></tr>',
			'</table>',
			'</div>'].join(''));
